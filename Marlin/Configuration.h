 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.40, 80.20, 407, 423 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, 10, -0.7 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS              31 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
