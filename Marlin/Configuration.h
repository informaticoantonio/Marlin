...
#define STRING_CONFIG_H_AUTHOR "(Antonio, GENIUS SRK1.4 Turbo - ZProbe - NoSensorLess)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "GENUIS-SKR1.4-Turbo"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "1943abc0-f7c7-407f-85c6-fb1e0a7bb85f"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 13.54,  13.54 }
    #define DEFAULT_Ki_LIST { 0.77,  0.77 }
    #define DEFAULT_Kd_LIST { 59.79, 59.79 }
  #else
    #define DEFAULT_Kp  13.54
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 33.60
  #define DEFAULT_bedKi 4.76
  #define DEFAULT_bedKd 158.20
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.88, 80.88, 398, 400 }
 ...
 */
//#define Z_MIN_PROBE_PIN 32 // Pin E0_DIAG_PIN link to ExtruderBoard
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -2, 39, -1.60 }
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_BED_TEMP      61    // (°C) Default bed temperature for the G26 Mesh Validation Tool.
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 2  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT 40  // Y point for Z homing
#endif

// Homing speeds (mm/min)
#define HOMING_FEEDRATE_MM_M { (80*60), (70*60), (15*60) }
