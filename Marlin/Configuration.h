...
#define STRING_CONFIG_H_AUTHOR "(EZY3D LAB, Artillery X1 MBL Marlin 2.0.5)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 5, 40 } //{ 300, 300, 50, 40 }
